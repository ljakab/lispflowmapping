...
public class LispInventoryService {
    ...
    private static String getNodeLabelFromAddressAndXtrId(InetAddress address, byte[] xtrId) {
        String addressLabel = getNodeLabelFromAddress(address);
        return addressLabel + "|" + ByteUtil.bytesToHex(xtrId, MapRegisterSerializer.Length.XTRID_SIZE);
    }

    public String inventoryUpdate(InetAddress address) {
        String nodeLabel = getNodeLabelFromAddress(address);
        return inventoryUpdate(nodeLabel);
    }

    public String inventoryUpdate(InetAddress address, byte[] xtrId) {
        String nodeLabel = getNodeLabelFromAddressAndXtrId(address, xtrId);
        return inventoryUpdate(nodeLabel);
    }

    public String inventoryUpdate(String nodeLabel) {
