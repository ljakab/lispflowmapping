...
import org.opendaylight.yang.gen.v1.lispflowmapping.rev131031.xtrsiteid.XtrSiteIdBuilder;
...
public class MapRegisterSerializer {
    ...
    public ByteBuffer serialize(MapRegister mapRegister) {
        ...
        if (mapRegister.isXtrSiteIdPresent()) {
            registerBuffer.put(mapRegister.getXtrSiteId().getXtrId());
            registerBuffer.put(mapRegister.getXtrSiteId().getSiteId());
        }
    ...
    public MapRegister deserialize(ByteBuffer registerBuffer) {
        try {
            ...
            if (xtrSiteIdPresent) {
                ...
                XtrSiteIdBuilder builder2 = new XtrSiteIdBuilder();
                builder2.setXtrId(xtrId);
                builder2.setSiteId(siteId);
                builder.setXtrSiteId(builder2.build());
            }
